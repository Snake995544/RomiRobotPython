...
class Drivetrain(commands2.Subsystem):
    ...
    def __init__(self) -> None:
        ...
        self.leftMotor = wpilib.Spark(constants.LEFT_MOTOR_ID)
        self.rightMotor = wpilib.Spark(constants.RIGHT_MOTOR_ID)

        # The Romi has onboard encoders that are hardcoded
        # to use DIO pins 4/5 and 6/7 for the left and right
        self.leftEncoder = wpilib.Encoder(constants.LEFT_ENCODER_CHANNEL_1, constants.LEFT_ENCODER_CHANNEL_2)
        self.rightEncoder = wpilib.Encoder(constants.RIGHT_ENCODER_CHANNEL_1, constants.RIGHT_ENCODER_CHANNEL_2)
